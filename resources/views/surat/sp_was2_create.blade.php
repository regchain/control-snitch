...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <small class="col-xs-3 pull-right text-justify">Lampiran Petunjuk Pelaksanaan JAMWAS Nomor ; 01/H/Hjw/04//2011 tanggal 01 April 2011 tentang Teknis Penanganan Laporandan Tata Kelola Administrasi Bidang Pengawasan<br><strong class="pull-right">SP.WAS-2</strong></small>
                ...
                <div class="col-sm-8">
                    <h4>
                        <div class="input-group" style="width: 95%">
                            <select class="form-control select2 no-border" name="warrant_2_by" id="warrant_2_by">
        ...
        <div class="box-body">
            <div class="col-sm-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="PRIN -" name="number_warrant_2" id="number_warrant_2">
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" id="spklarifikasi" name="date_warrant_2">
                    </div>
                    <!-- /.input group -->
                </div>
                <!-- /.form group -->
        ...
        <div class="box-body">
            @include('lapdu::surat.partials._sp_was2_create')
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            let counter = {{ $data->examiners_2 ? count($data->examiners_2)+1 : 1 }}
            ...
            $('#save-sp').click(function() {
                let data = {
                    '_method': 'PUT',
                    'warrant_2_by': $('#warrant_2_by').val(),
                    'number_warrant_2': $('#number_2_warrant').val(),
                    'date_warrant_2': $('#spklarifikasi').val()
                }
