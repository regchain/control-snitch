...
@section('content')
    ...
    <div class="box">
            ...
            <div class="box-body">
                @include('control-snitch::surat.partials._ba_was3_qna_create')
            </div>
            ...
            <div class="box-footer">
                ...
                <div class="row no-print">
                    <div class="col-xs-12">
                        ...
                        <a href="{{ route('lapdu.operator.inspeksi.action', ['id' => $data->_id]) }}" class="btn btn-default pull-right" style="margin-right: 5px;">
                            <i class="fa fa-mail-reply"></i> Proses Inspeksi
                        </a>
                    </div>
                </div>
                <!-- /.content -->
