...
<head>
    ...
    @include('vendor.lapdu.operator.head')
...
<div class="wrapper">
    ...
    <!-- Header -->
    @include('vendor.lapdu.operator.header')

    <!-- Sidebar -->
    @include('vendor.lapdu.operator.sidebar')
  ...
  <!-- Footer -->
    @include('vendor.lapdu.operator.footer')

  <!-- Control Sidebar -->

  @include('vendor.lapdu.operator.sidebar-right')
...
<!-- REQUIRED JS SCRIPTS -->
 ...
 @include('vendor.lapdu.operator.scripts')
