...
@section('content')
            ...
            <div class="btn-group bootstrap-select pull-right">
              ...
              <div class="dropdown-menu open" role="combobox">
                <ul class="dropdown-menu inner" role="listbox" aria-expanded="false">
                  <li data-original-index="0" class="selected"><a href="{{ route('lapdu.operator.putusan.index', ['status' => '-semua-']) }}" tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="true"><span class="text">- SEMUA -</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
 ...
 --}}
          ...
          @include('control-snitch::partials.subyek_putusan')
