<form action="{{ route('lapdu.operator.laporan.update', ['id' => $data->_id]) }}" method="post">
    ...
    <div class="box-footer">
        <a href="{{ route('lapdu.operator.laporan.warrant', ['id' => $data->_id]) }}" class="btn btn-info btn-flat pull-right" data-toggle="tooltip" data-placement="top" title="SURAT PERINTAH KLARIFIKASI" style="margin-right: 5px;"><i class="fa fa-plus"></i> SP.WAS-1</a>
    </div>
    @endif
</form>
